...
//!
//! Run:  cargo run -p tts-probe --release --bin qroundtrip -- q8_0 out.safetensors
...
const IN: &str = "references/audio8/weights/model.safetensors";
...
fn main() -> Result<()> {
    ...
    let out = args
        .next()
        .unwrap_or_else(|| format!("fixtures/audio8/ar_{qname}.safetensors"));
