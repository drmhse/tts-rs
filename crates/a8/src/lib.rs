...
//!
//! Layout mirrors the reference (`oracle/weights/modeling_arktts*.py`) closely enough
...
//! asset (`fixtures/default_voice_codes.safetensors`) and 126 encoder tensors stay
...
/// Model geometry, from `oracle/weights/config.json`. Hard-coded rather than parsed:
