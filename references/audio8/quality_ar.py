...
Usage:
    .venv/bin/python quality_ar.py --variants ../fixtures/audio8/ar_q8_0.safetensors \
        ../fixtures/audio8/ar_q4_1.safetensors
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", default="../fixtures/audio8/quality")
    args = ap.parse_args()
