...
`oracle/export_voice.py` does for Audio8's codec encoder. Only the frontend is
...
Usage:
    ...
    .venv/bin/python /path/to/oracle-cosy/export_voice.py \
        --model-dir pretrained_models/Fun-CosyVoice3-0.5B \
        --audio asset/default_voice.wav --text asset/default_voice.txt \
        --name cosy-default-cosyvoice --out /path/to/audio8-rs/voices
"""
        ...
        json.dumps(
            {
                ...
                "notes": (
                    ...
                    "exported by oracle-cosy/export_voice.py so neither ONNX model is "
